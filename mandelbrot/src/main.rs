...
fn concurrent_render(pixels: &mut [u8], bounds: (usize, usize), upper_left: Complex<f64>, lower_right: Complex<f64>) {
    let threads = 8;
...
fn write_image(filename: &str, pixels: &[u8], bounds: (usize, usize)) -> Result<(), std::io::Error>
{
    ...
    let encoder = PNGEncoder::new(output); encoder.encode(&pixels,
